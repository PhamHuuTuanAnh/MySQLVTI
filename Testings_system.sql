...
CREATE TABLE `account` (
    ...
    FullName		VARCHAR(50),
    DepartmentID	TINYINT UNSIGNED DEFAULT NULL, /*trường hợp nv chưa thuộc phòng ban nào dùng Default*/
...
INSERT INTO `account` (Email, Username, Fullname, DepartmentID, PositionID, CreatedDate)
	VALUES ('vti_account1@vtiacademy.com', 'vti1', 'Nguyen Van Tinh', 1, 1, '2019-12-01'),
           ...
           ('vti_account15@vtiacademy.com', 'vti15', 'Luu Duc Hoa', NULL, 1, '2021-07-01')
;
-- group
...
INSERT INTO exam (`Code`, Title, CategoryID, Duration, CreatorID, CreatedDate)
	VALUES ('MS_08', 'De thi 08', 1, 90, 1, '2019-08-30'),
           ...
           ('MS_10', 'De thi 10', 2, 60, 7, '2017-02-05')
;

-- examquestion
	-- Drop constraint foreign key before insert data
-- ALTER TABLE examquestion DROP CONSTRAINT fk_examquestion_exam;

-- ALTER TABLE examquestion DROP CONSTRAINT fk_examquestion_question;
